...
import com.stefan.hyyTool.language.R
...
object HyToast {
    ...
    fun normal(message: String) {
        normal(HyTool.getContext(), message, Toast.LENGTH_SHORT, null, false)?.show()
    }

    @JvmStatic
    fun normal(message: String, icon: Drawable?) {
        normal(HyTool.getContext(), message, Toast.LENGTH_SHORT, icon, true)?.show()
    }

    @JvmStatic
    fun normal(message: String, duration: Int) {
        normal(HyTool.getContext(), message, duration, null, false)?.show()
    }

    @JvmStatic
    fun normal(message: String, duration: Int, icon: Drawable?) {
        normal(HyTool.getContext(), message, duration, icon, true)?.show()
    }

    @JvmStatic
    fun normal(message: String, duration: Int, icon: Drawable?, withIcon: Boolean): Toast? {
        return custom(HyTool.getContext(), message, icon, DEFAULT_TEXT_COLOR, duration, withIcon)
    }

    @JvmStatic
    fun warning(message: String) {
        warning(HyTool.getContext(), message, Toast.LENGTH_SHORT, true)?.show()
    }

    @JvmStatic
    fun warning(message: String, duration: Int) {
        warning(HyTool.getContext(), message, duration, true)?.show()
    }

    @JvmStatic
    fun warning(message: String, duration: Int, withIcon: Boolean): Toast? {
        return custom(HyTool.getContext(), message, getDrawable(HyTool.getContext(), com.stefan.hyyTool.language.R.drawable.ic_error_outline_white_48dp), DEFAULT_TEXT_COLOR, WARNING_COLOR, duration, withIcon, true)
    }

    @JvmStatic
    fun info(message: String) {
        info(HyTool.getContext(), message, Toast.LENGTH_SHORT, true)?.show()
    }

    @JvmStatic
    fun info(message: String, duration: Int) {
        info(HyTool.getContext(), message, duration, true)?.show()
    }

    @JvmStatic
    fun info(message: String, duration: Int, withIcon: Boolean): Toast? {
        return custom(HyTool.getContext(), message, getDrawable(HyTool.getContext(), com.stefan.hyyTool.language.R.drawable.ic_info_outline_white_48dp), DEFAULT_TEXT_COLOR, INFO_COLOR, duration, withIcon, true)
    }

    @JvmStatic
    fun success(message: String) {
        success(HyTool.getContext(), message, Toast.LENGTH_SHORT, true)?.show()
    }

    @JvmStatic
    fun success(message: String, duration: Int) {
        success(HyTool.getContext(), message, duration, true)?.show()
    }

    @JvmStatic
    fun success(message: String, duration: Int, withIcon: Boolean): Toast? {
        return custom(HyTool.getContext(), message, getDrawable(HyTool.getContext(), com.stefan.hyyTool.language.R.drawable.ic_check_white_48dp), DEFAULT_TEXT_COLOR, SUCCESS_COLOR, duration, withIcon, true)
    }

    @JvmStatic
    fun error(message: String) {
        error(HyTool.getContext(), message, Toast.LENGTH_SHORT, true)?.show()
    }
    ...
    fun error(message: String, duration: Int) {
        error(HyTool.getContext(), message, duration, true)?.show()
    }

    @JvmStatic
    fun error(message: String, duration: Int, withIcon: Boolean): Toast? {
        return custom(HyTool.getContext(), message, getDrawable(HyTool.getContext(), com.stefan.hyyTool.language.R.drawable.ic_clear_white_48dp), DEFAULT_TEXT_COLOR, ERROR_COLOR, duration, withIcon, true)
    }
    ...
    fun warning(context: Context, message: String, duration: Int, withIcon: Boolean): Toast? {
        return custom(context, message, getDrawable(context, com.stefan.hyyTool.language.R.drawable.ic_error_outline_white_48dp), DEFAULT_TEXT_COLOR, WARNING_COLOR, duration, withIcon, true)
    }
    ...
    fun info(context: Context, message: String, duration: Int, withIcon: Boolean): Toast? {
        return custom(context, message, getDrawable(context, com.stefan.hyyTool.language.R.drawable.ic_info_outline_white_48dp), DEFAULT_TEXT_COLOR, INFO_COLOR, duration, withIcon, true)
    }
    ...
    fun showToastShort(str: String?) {
        Toast.makeText(HyTool.getContext(), str, Toast.LENGTH_SHORT).show()
    }
    ...
    fun showToastShort(resId: Int) {
        Toast.makeText(HyTool.getContext(), HyTool.getContext().getString(resId), Toast.LENGTH_SHORT).show()
    }
    ...
    fun showToastLong(str: String?) {
        Toast.makeText(HyTool.getContext(), str, Toast.LENGTH_LONG).show()
    }
    ...
    fun showToastLong(resId: Int) {
        Toast.makeText(HyTool.getContext(), HyTool.getContext().getString(resId), Toast.LENGTH_LONG).show()
    }
    ...
    fun showToast(msg: String?) {
        if (mToast == null) {
            mToast = Toast.makeText(HyTool.getContext(), msg, Toast.LENGTH_LONG)
        } else {
            mToast?.setText(msg)
        }
    ...
    fun showToast(resId: Int) {
        if (mToast == null) {
            mToast = Toast.makeText(HyTool.getContext(), HyTool.getContext().getString(resId), Toast.LENGTH_LONG)
        } else {
            mToast?.setText(HyTool.getContext().getString(resId))
        }
        mToast?.show()
    }
