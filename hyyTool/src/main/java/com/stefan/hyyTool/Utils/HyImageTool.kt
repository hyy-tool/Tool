...
import com.stefan.hyyTool.Utils.HyFileTool.Companion.closeIO
import com.stefan.hyyTool.Utils.HyFileTool.Companion.createOrExistsFile
import com.stefan.hyyTool.Utils.HyFileTool.Companion.getFileByPath
import java.io.*
...
object HyImageTool {
    ...
    fun dp2px(dpValue: Float): Int {
        return dp2px(HyTool.getContext(), dpValue)
    }
    ...
    fun px2dp(pxValue: Float): Int {
        return px2dp(HyTool.getContext(), pxValue)
    }
    ...
    fun sp2px(spValue: Float): Int {
        val fontScale = HyTool.getContext().resources.displayMetrics.scaledDensity
    ...
    fun getBitmap(resId: Int): Bitmap? {
        val `is` = HyTool.getContext().resources.openRawResource(resId)
