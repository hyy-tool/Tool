...
import com.example.hytool.total_directory.mvp.view.activity.activity_home_v3.txIm.FriendProfileActivity;
import com.example.hytool.total_directory.util.DemoLog;
        ...
        if (convertView != null) {
            ...
            mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    HyTool.getContext().startActivity(intent);
                }
            });
