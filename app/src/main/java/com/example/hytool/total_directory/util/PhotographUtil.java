package com.example.hytool.total_directory.util;
...
public class PhotographUtil {
    private static final PhotographUtil ourInstance = new PhotographUtil();

    public static PhotographUtil getInstance() {
        return ourInstance;
    }

    /**
     * @param activity
     * @param selectedCount 最多可以选择张数
     * @param isCamera      是否显示拍照按钮
     * @param data          传入已选图片
     */
    public void fromGallery(Activity activity, int selectedCount, boolean isCamera, List<LocalMedia> data) {
...
//                .setPictureWindowAnimationStyle(mWindowAnimationStyle)// 自定义相册启动退出动画
                ...
                .maxSelectNum(selectedCount)// 最大图片选择数量
                ...
                .withAspectRatio(160, 160)// 裁剪比例 如16:9 3:2 3:4 1:1 可自定义
