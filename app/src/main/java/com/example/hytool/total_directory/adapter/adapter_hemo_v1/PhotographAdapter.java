...
import com.example.hytool.total_directory.util.OnItemClickListener;
import com.example.hytool.total_directory.util.OnItemLongClickListener;
...
public class PhotographAdapter extends RecyclerView.Adapter<PhotographAdapter.ViewHolder> {
    ...
    public PhotographAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = mInflater.inflate(R.layout.item_photograph,
                viewGroup, false);
