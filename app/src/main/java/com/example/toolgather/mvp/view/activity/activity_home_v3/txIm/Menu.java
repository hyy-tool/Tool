...
//                    Intent intent = new Intent(RxTool.getContext(), AddMoreActivity.class);
...
//                    Intent intent = new Intent(RxTool.getContext(), StartC2CChatActivity.class);
//                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//                    mActivity.startActivity(intent);
                }

                if (TextUtils.equals(action.getActionName(), mActivity.getResources().getString(R.string.create_private_group))) {
//                    Intent intent = new Intent(RxTool.getContext(), StartGroupChatActivity.class);
//                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
