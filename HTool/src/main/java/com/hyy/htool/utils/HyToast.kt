...
//*******************************************普通 使用ApplicationContext 方法*********************
    ...
    fun warning(message: String, duration: Int, withIcon: Boolean): Toast? {
        return custom(
            HyTool.getContext(),
            message,
            getDrawable(HyTool.getContext(), R.drawable.ic_error_outline_white_48dp),
            DEFAULT_TEXT_COLOR,
            WARNING_COLOR,
            duration,
            withIcon,
    ...
    fun info(message: String, duration: Int, withIcon: Boolean): Toast? {
        return custom(
            HyTool.getContext(),
            message,
            getDrawable(HyTool.getContext(), R.drawable.ic_info_outline_white_48dp),
            DEFAULT_TEXT_COLOR,
            INFO_COLOR,
            duration,
            withIcon,
    ...
    fun success(message: String, duration: Int, withIcon: Boolean): Toast? {
        return custom(
            HyTool.getContext(),
            message,
            getDrawable(HyTool.getContext(), R.drawable.ic_check_white_48dp),
            DEFAULT_TEXT_COLOR,
            SUCCESS_COLOR,
            duration,
            withIcon,
...
//*******************************************常规方法********************************************
    ...
    fun error(message: String, duration: Int, withIcon: Boolean): Toast? {
        return custom(
            HyTool.getContext(),
            message,
            getDrawable(HyTool.getContext(), R.drawable.ic_clear_white_48dp),
            DEFAULT_TEXT_COLOR,
            ERROR_COLOR,
            duration,
            withIcon,
